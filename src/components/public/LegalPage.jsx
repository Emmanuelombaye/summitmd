    ...
    <div className="landing-layout animate-fade-in" style={{ paddingTop: '100px', minHeight: '100vh' }}>
      ...
      <section className="container" style={{ marginBottom: '60px', maxWidth: '800px' }}>
        ...
        <p style={{ color: 'var(--color-text-muted)', fontSize: '1.1rem', marginBottom: '40px' }}>
          Review Teladoc Health's clinical terms of service, patient security disclosures, and HIPAA compliance policies.
        </p>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.9rem', color: 'var(--color-text-muted)', marginTop: '8px', lineHeight: 1.7 }}>
              Teladoc Health virtual consultations are designed for non-emergency healthcare requirements. All clinical decisions are executed by board-certified physicians acting under individual state licensure credentials.
            </p>
          </div>
        </div>
      </section>
